...
def compute_pressure_forces(points, wave_heights, directions, face_ids, 
                               g_center, rho, g, d_uuv):
    """
    GPU加速版本的主函数
    """
...
SKIPPED_GROUP_NUM=0
idx=0
index_name="./dataset-1/index.csv"
for group in data_setting_group:
    ...
    csv_name="./dataset-1/"+save_name+".csv"
    jpg_name="./dataset-1/"+save_name+".jpg"
